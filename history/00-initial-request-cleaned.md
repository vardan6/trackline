...
8. When context becomes too large, often around 60k-80k tokens on the older 200k baseline, I ask the agent to save enough information to continue in the next session.
...
- how to keep context under a model-aware token budget, stated in both k-tokens and status-line percentage
