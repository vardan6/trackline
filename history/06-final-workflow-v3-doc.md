...
At around 100k tokens, suggest handoff; do not push past around 120k tokens.
...
- suggest handoff around 100k tokens
- compact around 120k tokens, not near the model limit
...
- context-threshold hook: warn around 100k tokens to consider handoff
